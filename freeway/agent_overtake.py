...
class Agent(object):
    ...
    def _bh_is_vehicle_hazard(self, ego_wpt, ego_loc, vehicle_list,
        ...
        """
        ----- this version is modified for car following -----
        ...
        for target_vehicle in vehicle_list:
            ...
            if target_wpt.road_id != ego_wpt.road_id or \
                ...
                # change step from 5 to 0 for overtaking 
                next_wpt = self._local_planner.get_incoming_waypoint_and_direction(steps=0)[0]
