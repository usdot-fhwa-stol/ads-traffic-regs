package adsregs.util.dbf;

import adsregs.util.Utility;
...
public class DbfResultSet implements ResultSet
{
	 ...
	 * @throws Exception
	 */
	public DbfResultSet(ByteArrayInputStream oByteStream) throws Exception
	{
		m_oDataInputStream = new DataInputStream(oByteStream);
